            ...
            <Container py={50}>            
                <Group justify="space-between">
                    <form action="https://formsubmit.co/victorferreira8613@gmail.com" method="POST" style={{width: 500}}>            
                        <TextInput label="Nome" placeholder="Digite seu nome aqui" name="name" />
                        <TextInput label="Email" placeholder="Digite seu email aqui" type="email" name="email" />
                    ...
                    <Stack>
                        <Flex gap={3} align="center">
                            ...
                            <Text mt={-8} size="xl" fw={100}>victorferreira8613@gmail.com</Text>
                        </Flex>
                        <Flex gap={3}>
                            <Image opacity={0.7} src="/whatsapp.svg?react" h={22} w={22} />
                            <Text mt={-8} size="xl" fw={100} onClick={() => window.open("https://wa.me/5581984613388")} style={{cursor: "pointer"}}>(81) 9.8461-3388</Text>
                        </Flex>
                    </Stack>
                </Group>
            </Container>
